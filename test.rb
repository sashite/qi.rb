...
actual = begin
  [].reduce(STARTING_POSITION_PIECE_SET) do |piece_set, action_items|
    Qi.call(*action_items, **piece_set)
  end
end
...
actual = begin
  [[56, 47, "P"]].reduce(STARTING_POSITION_PIECE_SET) do |piece_set, action_items|
    Qi.call(*action_items, **piece_set)
  end
end
...
actual = begin
  [[56, 47, "P"], [3, 11, "g"]].reduce(STARTING_POSITION_PIECE_SET) do |piece_set, action_items|
    Qi.call(*action_items, **piece_set)
  end
end
...
actual = begin
  [[56, 47, "P"], [3, 11, "g"], [64, 24, "+B", "P"]].reduce(STARTING_POSITION_PIECE_SET) do |piece_set, action_items|
    Qi.call(*action_items, **piece_set)
  end
end
...
actual = begin
  [[56, 47, "P"], [3, 11, "g"], [64, 24, "+B", "P"], [5, 14, "g"]].reduce(STARTING_POSITION_PIECE_SET) do |piece_set, action_items|
    Qi.call(*action_items, **piece_set)
  end
end
...
actual = begin
  [[56, 47, "P"], [3, 11, "g"], [64, 24, "+B", "P"], [5, 14, "g"], [24, 14, "+B", "G"]].reduce(STARTING_POSITION_PIECE_SET) do |piece_set, action_items|
    Qi.call(*action_items, **piece_set)
  end
end
...
actual = begin
  [[56, 47, "P"], [3, 11, "g"], [64, 24, "+B", "P"], [5, 14, "g"], [24, 14, "+B", "G"], [4, 3, "k"]].reduce(STARTING_POSITION_PIECE_SET) do |piece_set, action_items|
    Qi.call(*action_items, **piece_set)
  end
end
...
actual = begin
  [[56, 47, "P"], [3, 11, "g"], [64, 24, "+B", "P"], [5, 14, "g"], [24, 14, "+B", "G"], [4, 3, "k"], [nil, 13, "G"]].reduce(STARTING_POSITION_PIECE_SET) do |piece_set, action_items|
    Qi.call(*action_items, **piece_set)
  end
end
